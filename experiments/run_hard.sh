...
flags_drone4D="--model Drone4D --layout 2 --logger_prefix Drone4D --pretrain_total_steps 1000000 --hidden_layers 2 --mesh_loss 0.01 --mesh_verify_grid_init 0.06 --refine_threshold 50000000 --verify_threshold 600000000 --noise_partition_cells 12 --max_refine_factor 2 --verify_batch_size ${verify_batch_size}"
flags_drone4Db="--model Drone4D --layout 2 --logger_prefix Drone4Db --pretrain_total_steps 1000000 --hidden_layers 3 --mesh_loss 0.01 --mesh_verify_grid_init 0.06 --refine_threshold 50000000 --verify_threshold 600000000 --noise_partition_cells 12 --max_refine_factor 2 --verify_batch_size ${verify_batch_size}"
