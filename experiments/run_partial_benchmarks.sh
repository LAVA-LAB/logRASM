...
flags_triple="--model TripleIntegrator --logger_prefix TripleIntegrator --pretrain_total_steps 100000 --hidden_layers 3 --mesh_loss 0.005 --mesh_loss_decrease_per_iter 0.9 --mesh_verify_grid_init 0.04 --mesh_verify_grid_min 0.04 --noise_partition_cells 6 --max_refine_factor 4 --verify_batch_size ${triple_batch_size}"
